...
const AddRoom = () => {
  ...
  // Helper function to handle image selection and validation
  ...
  return (
    ...
    >
      <Title
        ...
        font="outfit"
        title="Add Room"
        subTitle="To improve the user booking experience, fill in the room features, 
      amenities, and pricing with precision."
      />

      {/* Upload Area For Images */}
      <div className="mt-8">
        <p className="text-gray-800 font-medium mb-2">Room Images</p>
        <p className="text-sm text-gray-500 mb-3">
          Upload up to 4 images of your room (required)
        </p>
      ...
      <button
        className="bg-primary text-white px-8 py-3 rounded-lg mt-8 cursor-pointer hover:bg-primary-dull transition-all duration-300 flex items-center justify-center disabled:bg-gray-300 disabled:cursor-not-allowed"
        disabled={loading}
      >
        {loading ? (
          <>
